    ...
    <el-table
      ...
      <el-table-column label="操作">
        <template #default="scope" >
          ...
          <el-button size="mini" @click="handleEdit(scope.row)" v-if="scope.row.author === user.nickName || user.role === 1">编辑</el-button>
          <el-popconfirm title="确定删除吗？" @confirm="handleDelete(scope.row.id)" v-if="scope.row.author === user.nickName || user.role === 1">
            <template #reference>
